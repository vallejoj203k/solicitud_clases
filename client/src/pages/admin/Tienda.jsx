...
import { IconoMas, IconoTienda, IconoFoto } from '../../components/Iconos.jsx';
 ...
 * la foto, la descripción y el precio, pero no hay pedidos ni inventario que
 * gestionar. Vender sigue siendo cosa del mostrador.
 */
      ...
      <div className="px-5 md:px-8 pb-10 space-y-4">
        ...
        {!isLoading && lista.length === 0 && (
          <Vacio
            ...
            descripcion="Agrega el primero: foto, descripción y precio."
